		...
		<form action="">
			...
			<div class="form-container">
				<div class="form-block">
					...
					<div class="form-item">
						<div class="address">
							<label for="address">Rue :</label> <input type="text" name="rue"
								id="rue">
						</div>
						<div class="form-block">
							<div class="form-item">
								<div class="postalcode">
									<label for="postalcode">Code Postal</label> <input type="text"
										name="code" id="postalcode">
								</div>
							</div>
						</div>
						<div class="town">
							<label for="town">Ville</label> <input type="text" name="ville"
								id="town">
						</div>
					</div>
				</div>
				...
				<input class="btn-save" type="button"
					value="Enregistrer mes modifications">
			</div>
		</form>
	</section>
