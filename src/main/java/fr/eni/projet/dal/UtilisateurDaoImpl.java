...
public class UtilisateurDaoImpl implements UtilisateurDAO {
	...
	public Utilisateur selectById(int id) throws DALException {
		...
		try {
			...
			throw new DALException("probl�me avec la m�thode selectById", e);
		}
	...
	public void updateUtilisateur(Utilisateur utilisateur,String oldPseudo) throws DALException {
		try {
			...
			throw new DALException("probl�me avec la m�thode updateUtilisateur", e);
		}
	}
	...
	public Utilisateur selectConnexion(String identifiant, String password) throws DALException {
		...
		try {
			...
			throw new DALException("probl�me avec la m�thode selectConnexion", e);
		}
